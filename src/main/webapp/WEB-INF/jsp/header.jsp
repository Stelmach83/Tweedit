                ...
                <c:choose>
                    <c:when test="${not empty user}">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/login?logout">${user.getPoints()} points</a></li>
                            <li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/login?logout">logout</a></li>
                        </ul>
                    </c:when>
                    <c:otherwise>
